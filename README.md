...
- fpm-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- fpm-ui: main application module, development time
- fpm-production: module that produces a production mode WAR for deployment
