      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setClass("com.example.fpm.samples.ResetButtonForTextField", com.example.fpm.client.samples.ResetButtonForTextFieldConnector.class);
            ...
            store.setConstructor(com.example.fpm.client.samples.ResetButtonForTextFieldConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.example.fpm.client.samples.ResetButtonForTextFieldConnector.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(com.example.fpm.client.samples.ResetButtonForTextFieldConnector.class, "getState", new Type(com.vaadin.shared.communication.SharedState.class));
          ...
          private void load4() {
            ...
            store.setPropertyType(com.vaadin.shared.AbstractFieldState.class, "focusDelegate", new Type(com.vaadin.shared.Connector.class));
          ...
          private native void loadNativeJs0(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.vaadin.shared.AbstractFieldState::focusDelegate = value;
              },
              getter: function(bean) {
                return bean.@com.vaadin.shared.AbstractFieldState::focusDelegate;
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.vaadin.shared.AbstractFieldState::class, 'focusDelegate', data);
