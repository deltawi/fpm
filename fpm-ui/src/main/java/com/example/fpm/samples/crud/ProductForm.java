package com.example.fpm.samples.crud;

import java.util.Collection;

import com.example.fpm.samples.backend.DataService;
import com.example.fpm.samples.backend.data.Availability;
import com.example.fpm.samples.backend.data.Category;
import com.example.fpm.samples.backend.data.Product;
